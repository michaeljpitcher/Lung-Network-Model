...
class TBFullTestCase(unittest.TestCase):
    ...
    def test_bacteria_replication(self):
        ...
        self.network.update_totals()
        self.network.bacteria_replication(BACTERIA_FAST)
        ...
        self.network.update_totals()
        self.network.bacteria_replication(BACTERIA_SLOW)
        ...
        self.network.update_totals()
        self.network.bacteria_replication(BACTERIA_INTRACELLULAR)
