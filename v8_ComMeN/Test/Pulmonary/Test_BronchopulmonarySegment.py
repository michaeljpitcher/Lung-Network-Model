...
from v8_ComMeN.ComMeN.Pulmonary.Node.BronchopulmonarySegment import BronchopulmonarySegment
...
class BronchopulmonarySegmentTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.comps = ['a','b']
        self.node_high_O2 = BronchopulmonarySegment(0, self.comps, 0.3, 0.01, (0, 0))
        self.node_low_O2 = BronchopulmonarySegment(0, self.comps, 0.9, 0.89, (0, 0))
        self.node_zero_O2 = BronchopulmonarySegment(0, self.comps, 0.9, 0.9, (0, 0))
