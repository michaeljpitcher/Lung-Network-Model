...
class RecruitmentBronchialByInfectionTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.event = RecruitmentBronchialByInfection(0.1, self.comp, self.infect_comps)
        self.event_not_perfusion = RecruitmentBronchialByInfection(0.1, self.comp, self.infect_comps, False)
...
class RecruitmentLymphByInfectionTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.comp = 'comp'
        self.infect_comps = ['inf_1', 'inf_2']
        self.event = RecruitmentLymphByInfection(0.1, self.comp, self.infect_comps)
