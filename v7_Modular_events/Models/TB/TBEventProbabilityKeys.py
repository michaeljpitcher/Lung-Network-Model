...
P_REPLICATION_BACTERIA = 'p_replication_B'
...
P_TRANSLOCATE_BRONCHUS_BACTERIA = 'p_translocate_bronchus_B'
...
P_INGEST_AND_DESTROY_MACROPHAGE_FAST = 'p_ingest_destroy_M_B_f'
P_INGEST_AND_DESTROY_MACROPHAGE_SLOW = 'p_ingest_destroy_M_B_s'
